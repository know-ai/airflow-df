...
"""
    ...
    def test_read_raw_file_2022(self):
        filepath = os.path.join("data", "olga2022", "1.tpl")
        tpl = TPL()

        expected = """'OLGA 2022.1.0.35696'
TIME PLOT
INPUT FILE
'1.genkey'
PVT FILE
'../../../Documents/iDetect fugas/00 Fluidos/01 Diesel/Diesel_1.tab' 
DATE
'23-07-07 13:12:34'
PROJECT
'Supe'
...
'PIPELINE'
18
0.0000000000000000e+00 1.5000000000000000e+00 3.0000000000000000e+00 9.8499999999999996e+00 1.6699999999999999e+01 
1.8699999999999999e+01 2.0699999999999999e+01 2.9299999999999997e+01 3.7899999999999999e+01 4.5399999999999999e+01 
5.2899999999999999e+01 5.6613999999999999e+02 1.0793800000000001e+03 1.2220300000000002e+03 1.3646800000000003e+03 
1.3656800000000003e+03 1.3666800000000003e+03 1.4300300000000002e+03 1.4933800000000001e+03 
0.0000000000000000e+00 0.0000000000000000e+00 0.0000000000000000e+00 6.8499999999999996e+00 1.3699999999999999e+01 
1.3699999999999999e+01 1.3699999999999999e+01 5.1000000000000014e+00 -3.5000000000000000e+00 -3.5000000000000000e+00 
-3.5000000000000000e+00 2.7500000000000000e+00 9.0000000000000000e+00 9.0000000000000000e+00 9.0000000000002274e+00 
1.0000000000000227e+01 1.1000000000000000e+01 1.1000000000000000e+01 1.1000000000000000e+01 
CATALOG 
3
PT 'POSITION:' 'PIPELINE@1378M' '(PA)' 'Pressure'
GT 'POSITION:' 'PIPELINE@1378M' '(KG/S)' 'Total mass flow'
PTLKUP 'LEAK:' 'LEAK' '(PA)' 'Pressure at the position where Leak is positioned'
TIME SERIES  ' (S)  '
0.000000e+00 6.435604e+05 1.047909e+02 8.461438e+05
1.005464e+00 6.614656e+05 1.063973e+02 9.237623e+05
2.070927e+00 6.847040e+05 1.103460e+02 9.343832e+05
3.136391e+00 6.968823e+05 1.112111e+02 9.235612e+05
"""

        self.assertEqual(tpl.read_raw_file(filepath=filepath), expected)
    
    def test_info_2022(self):
        ...
        expected = {
            ...
            'input_file': '1.genkey',
            'pvt_file': '../../../Documents/iDetect fugas/00 Fluidos/01 Diesel/Diesel_1.tab' ,
            'date': '23-07-07 13:12:34',
            'project': 'Supe',
            'title': '',
            'author': 'Jesus E Varajas',
            'network': 1,
    ...
    def test_data_structure_2022(self):
        ...
        expected_df_serialized = {
            "TIME SERIES  ' (S)  '": [0.000000e+000, 1.005464e+000, 2.070927e+00, 3.136391e+00],
            "PT 'POSITION:' 'PIPELINE@1378M' '(PA)' 'Pressure'":[6.435604e+05, 6.614656e+05, 6.847040e+05, 6.968823e+05],
            "GT 'POSITION:' 'PIPELINE@1378M' '(KG/S)' 'Total mass flow'": [1.047909e+02, 1.063973e+02, 1.103460e+02, 1.112111e+02],
            "PTLKUP 'LEAK:' 'LEAK' '(PA)' 'Pressure at the position where Leak is positioned'": [8.461438e+05, 9.237623e+05, 9.343832e+05, 9.235612e+05]
        }
