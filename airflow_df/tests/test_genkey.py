...
class TestGenkey(unittest.TestCase):
    ...
    def test_read_2022(self):

        filepath = os.path.join("data", "olga2022", "1.genkey")
        genkey = Genkey()
        file = genkey.read(filepath=filepath)
        ...
        with self.subTest(f"Test Primary Keys"):
            ...
            expected = [
                "Generated with OLGA version 2022.1.0",
                "Global keywords",
                "Library keywords",
                "Network Component",
                "Connections"
    ...
    def test_global_keywords_options_2022(self):
        ...
        with self.subTest(f"Test Global Keywords Files"):
            expected = {
                "PVTFILE": "../../../Documents/iDetect fugas/00 Fluidos/01 Diesel/Diesel_1.tab"
            }
            self.assertEqual(file["Global keywords"]["FILES"], expected)
        ...
        with self.subTest(f"Test Global Keywords Server"):
            expected = {
                "EXPOSE": "ALL"
            }
            self.assertEqual(file["Global keywords"]["SERVER"], expected)
    ...
    def test_library_keywords_2022(self):
    ...
    def test_connections_2022(self):
    ...
    def test_network_component_2022(self):
